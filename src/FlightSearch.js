                    ...
                    <form id="flightSearchForm" onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                ...
                                <input type="text" id="origin" placeholder="Enter origin" value={origin} onChange={handleOriginChange} />
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                <i className="input-group-icon fas fa-map-marker-alt"></i>
                                <input type="text" id="destination" placeholder="Enter destination" value={destination} onChange={handleDestinationChange} />
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <div className="input-group input-group-date">
                                <div className="input-group-item">
                                    ...
                                    <input type="date" id="departure" placeholder="Select departure date" value={departureDate} onChange={handleDepartureDateChange} />
                                </div>
                                <div className="input-group-item">
